...
const CourseDescription = ({user}) => {
    ...
    const checkoutHanlder = async () => {
      ...
      const options = {
        key: "rzp_test_CvHvyr5uUUCeTk", // Enter the Key ID generated from the Dashboard
        amount: order.id, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
        currency: "INR",
        name: "E-Learning", //your business name
        description: "Learn Anythings, Anytime, Anywhere",
        // image: "C:\Users\Ragini Singh\OneDrive\Documents\Desktop\skill india\logo.png",
          ...
          <div className="course-header">
...

            {
                user && user.subscription.includes(course._id) ? (
                    ...
                    <button onClick={checkoutHanlder} className='common-btn'>Enroll Now</button>
                )
            }
